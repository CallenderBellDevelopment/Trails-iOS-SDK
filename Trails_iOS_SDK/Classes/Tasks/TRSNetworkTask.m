...
- (void)parseJsonSuccess:(NSDictionary *)json {
    TRSResponseObject *response = [TRSResponseObject new];
...
- (void)finishRequestWithResponse:(TRSResponseObject *)response {
...
- (void)finishCachedRequestWithResponse:(TRSResponseObject *)response {
    [TRSCookieManager saveCookies];
